...
string textReaderText = "TextReader é a classe base abstrada" +
...
while(true)
{
    ...
    caracterConvertido = Convert.ToChar(caractereLido); // converte pra um caractere da tabela ascii
...
Console.WriteLine($"Texto armazenado na stringWrites: {sw.ToString()}");
